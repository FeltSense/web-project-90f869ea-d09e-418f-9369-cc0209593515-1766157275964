  ...
  const features: Feature[] = [
    {
      ...
      description: 'Generate unlimited unique recipes tailored to your ingredients and preferences using advanced AI technology.',
    ...
    },
    {
      ...
      description: 'Get custom weekly meal plans designed specifically for your dietary goals and lifestyle needs.',
    ...
    },
    {
      ...
      description: 'Auto-generate organized shopping lists with ingredient quantities and estimated costs.',
    ...
    },
    {
      ...
      description: 'Filter recipes by allergies, dietary restrictions, and preferences including vegan, keto, and gluten-free.',
    ...
    },
    {
      ...
      description: 'Discover and share recipes with a vibrant community of food enthusiasts and culinary experts.',
