        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-white mb-6 sm:mb-8 tracking-tight leading-tight drop-shadow-2xl">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 via-cyan-300 to-blue-400 font-black">Smart Recipes • Personalized Meals • Endless Possibilities</span>
            </h1>
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-5 sm:gap-6 justify-center pt-12 sm:pt-16 px-2">
            ...
            >
              ...
              <span className="relative z-10 flex flex-col items-center gap-1 whitespace-nowrap">
                <span className="text-base sm:text-lg font-black">🚀 Start Your AI Cooking Journey</span>
                <span className="text-xs font-bold opacity-95">7 Days Free • Unlimited Recipes • No Credit Card</span>
              </span>
            </Link>
            <Link 
