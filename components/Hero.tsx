        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-lg sm:text-xl text-slate-300 mt-6 sm:mt-8 px-2 font-medium max-w-4xl mx-auto leading-relaxed">
              Discover unlimited AI-generated recipes tailored to your taste, dietary needs, and available ingredients. Get personalized meal plans, smart shopping lists, and nutrition tracking—all powered by advanced AI that saves you 10+ hours every week and $1,200+ annually on groceries.
            </p>
