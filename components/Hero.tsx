        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-lg sm:text-xl text-slate-300 mt-6 sm:mt-8 px-2 font-medium max-w-4xl mx-auto leading-relaxed">
              Stop wasting time on meal planning. Get personalized recipes in seconds, auto-generated meal plans, and smart shopping lists powered by AI. Save 10+ hours weekly, cut grocery costs by 40%, and enjoy restaurant-quality meals at home. Join 100,000+ home cooks already transforming their kitchen routine.
            </p>
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center pt-8 sm:pt-12 px-2">
            ...
            >
              ...
              <span className="relative z-10 flex flex-col items-center gap-1 whitespace-nowrap">
                <span className="text-base sm:text-lg">🚀 Get Started Free Today</span>
