        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-lg sm:text-xl text-slate-300 mt-6 sm:mt-8 px-2 font-medium max-w-4xl mx-auto leading-relaxed">
              Get unlimited AI-generated recipes personalized to your taste, dietary needs, and ingredients. Enjoy smart meal planning, automated shopping lists, and nutrition tracking—all powered by advanced AI. Save 10+ hours weekly and $1,200+ annually on groceries while eating healthier and enjoying meals you actually love.
            </p>
