        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-lg sm:text-xl text-slate-300 mt-6 sm:mt-8 px-2 font-medium max-w-4xl mx-auto leading-relaxed">
              Your AI-powered personal chef generates unlimited recipes tailored to your taste, dietary needs, and available ingredients. Get personalized meal plans, smart shopping lists, nutrition tracking, and ingredient substitutions—all in seconds. Join 100,000+ users saving 10+ hours weekly and cutting grocery costs by $1,200+ annually.
            </p>
