        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-7xl font-bold text-white mb-6 sm:mb-8 tracking-tight leading-tight">
              Your Personal AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500">Chef & Meal Planner</span>
            </h1>
            <p className="text-lg sm:text-xl text-slate-300 mt-6 sm:mt-8 px-2 font-medium max-w-4xl mx-auto leading-relaxed">
              Transform your kitchen with AI-powered recipe generation. Get personalized recipes in seconds, auto-optimized meal plans, smart shopping lists, and complete nutrition tracking—all tailored to your taste, dietary needs, and available ingredients. Save 10+ hours weekly, cut grocery costs by $1,200+ annually, and never wonder "what's for dinner?" again. Join 100,000+ users who've revolutionized how they eat.
            </p>
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center pt-8 sm:pt-12 px-2">
            ...
            >
              ...
              <span className="relative z-10 flex flex-col items-center gap-1 whitespace-nowrap">
                ...
                <span className="text-xs sm:text-sm font-semibold opacity-90">7 days free • No credit card required</span>
              </span>
            </Link>
            <Link 
              href="#features" 
