        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-2">
              Never ask "what's for dinner?" again. Stop wasting time on meal planning. Get personalized recipes tailored to your ingredients, dietary goals, and taste preferences—all powered by cutting-edge AI. Save 10+ hours weekly, reduce food waste by 40%, and enjoy restaurant-quality meals at home.
            </p>
