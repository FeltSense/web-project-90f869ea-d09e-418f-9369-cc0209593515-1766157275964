          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-8 leading-tight tracking-tight drop-shadow-2xl">
              ...
              <span className="block bg-gradient-to-r from-emerald-300 via-cyan-300 to-blue-300 bg-clip-text text-transparent mt-3 font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
                Never Stress About Dinner Again • Save 10+ Hours Weekly • Cut Grocery Bills 30%
              </span>
            </h1>
            ...
            <div className="mt-8 inline-block px-8 py-4 rounded-2xl bg-gradient-to-r from-emerald-500/30 via-cyan-500/30 to-blue-500/30 border-2 border-emerald-300/80 backdrop-blur-lg shadow-2xl shadow-emerald-500/40 hover:shadow-emerald-500/60 transition-all duration-300 hover:scale-105">
              <p className="text-lg sm:text-xl font-bold text-white leading-relaxed">
                <span className="text-emerald-200">✨ Get unlimited AI-powered recipes</span> personalized to your taste in seconds. <span className="text-cyan-200">Join 100K+ home cooks</span> who are already saving 10+ hours weekly and cutting grocery bills by 30%. <span className="text-blue-200">100% free—no credit card needed.</span>
              </p>
            </div>
            ...
            <div className="mt-32 mb-16 p-12 rounded-3xl bg-gradient-to-r from-cyan-600/50 via-emerald-600/50 to-blue-600/50 border-2 border-cyan-300/95 backdrop-blur-xl shadow-2xl shadow-cyan-500/90 relative overflow-hidden group hover:shadow-cyan-500/110 transition-all duration-300 hover:scale-102">
              ...
              <div className="relative z-10 text-center mb-12">
                ...
                <p className="text-xl text-slate-50 max-w-3xl mx-auto leading-relaxed">Experience the complete AI-powered cooking solution that combines intelligent recipe generation, smart meal planning, and budget optimization—all in one platform.</p>
              </div>
            ...
            <div className="mt-20 p-12 rounded-3xl bg-gradient-to-r from-cyan-600/70 via-emerald-600/70 to-blue-600/70 border-2 border-cyan-200/95 backdrop-blur-xl shadow-2xl shadow-cyan-500/80 hover:shadow-cyan-500/100 transition-all duration-300 relative overflow-hidden group hover:scale-105">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-4xl sm:text-5xl font-bold text-white mb-4">🍽️ Transform Your Kitchen Today - Never Stress About Dinner Again</h3>
                <p className="text-xl text-slate-50 max-w-2xl mx-auto mb-8 leading-relaxed font-medium">
                  Join <span className="font-bold text-emerald-200">100K+ home cooks</span> who are already <span className="font-bold text-cyan-200">saving 10+ hours weekly on meal planning</span>, <span className="font-bold text-blue-200">cutting grocery bills by 30%</span>, and <span className="font-bold text-emerald-200">reducing food waste by 40%</span>. Get unlimited AI-powered recipes personalized to your taste and cooking skill level. <span className="font-bold text-yellow-200">Completely free—no credit card, no commitment, instant access.</span>
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                  ...
                  >
                    🚀 Start Your Free Trial Now - No Credit Card
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="relative p-8 rounded-2xl bg-gradient-to-br from-emerald-600/35 to-teal-600/35 border-2 border-emerald-400/80 hover:border-emerald-300/90 transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-500/70 group cursor-pointer hover:scale-105">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-50 text-sm leading-relaxed mb-4">Plan entire weeks in minutes. Our AI generates balanced meal plans that consider nutrition, taste, variety, allergies, and budget constraints automatically.</p>
            ...
            <div className="relative p-8 rounded-2xl bg-gradient-to-br from-purple-600/35 to-pink-600/35 border-2 border-purple-400/80 hover:border-purple-300/90 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/70 group cursor-pointer hover:scale-105">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-50 text-sm leading-relaxed mb-4">Get organized shopping lists with budget-friendly alternatives and intelligent substitutions. Our AI finds the best deals and organizes items by store section.</p>
            ...
            <div className="relative p-8 rounded-2xl bg-gradient-to-br from-orange-600/35 to-red-600/35 border-2 border-orange-400/80 hover:border-orange-300/90 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/70 group cursor-pointer hover:scale-105">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-50 text-sm leading-relaxed mb-4">Automatic nutrition analysis for every recipe with detailed breakdowns of calories, protein, carbs, fats, and micronutrients. Hit your health goals effortlessly.</p>
